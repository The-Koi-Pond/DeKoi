...
export function getProviderConnectionProviderOption(
  ...
  return (
    PROVIDER_CONNECTION_PROVIDER_OPTIONS.find(
      (option) => option.value === normalizedProvider,
...
export function isProviderConnectionProvider(
  ...
  return (
    typeof value === "string" &&
    PROVIDER_CONNECTION_PROVIDER_VALUES.includes(
      value as ProviderConnectionProvider,
    )
  );
}
  ...
  return {
    ...
    maxOutput:
      typeof record.maxOutput === "number" && Number.isFinite(record.maxOutput)
        ...
        : null,
    createdAt: normalizeProviderConnectionText(
      record.createdAt,
      defaultTimestamp,
    ),
    updatedAt: normalizeProviderConnectionText(
      record.updatedAt,
      defaultTimestamp,
    ),
  };

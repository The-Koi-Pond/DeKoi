    ...
    <div className="pond-eye">
      ...
      <div className="orbit" style={{ "--T": "26s" } as React.CSSProperties}>
        <div
          className="koi-wrap"
          style={
            { "--R": "78px", "--still-angle": "30deg", animationDelay: "0s" } as React.CSSProperties
          }
        >
          <div className="koi">
            <svg
              className="koi-swimmer"
              width="30"
              height="17"
              viewBox="0 0 32 18"
              style={{ color: "var(--koi)" }}
      ...
      <div className="orbit ccw" style={{ "--T": "18s" } as React.CSSProperties}>
        <div
          className="koi-wrap"
          style={
            { "--R": "48px", "--still-angle": "70deg", animationDelay: "0s" } as React.CSSProperties
          }
        >
          <div className="koi">
            <svg
